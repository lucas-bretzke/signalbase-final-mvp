...
const workflowSteps = [
  ...
  },
  {
    ...
    text: 'Escolha score mínimo, contato corporativo, celular e a exigência de correspondência entre sócio e decisor.',
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'É um resultado que passou pelo score mínimo e pelas regras que você configurou. A validação de e-mail e telefone é técnica; não equivale a garantia de entregabilidade, titularidade ou consentimento.',
  },
  {
...
function WorkflowPreview({ step }: { step: number }) {
  ...
  if (step === 1) return <div className="workflow-preview criteria-preview"><label>Score mínimo <strong>80</strong><span><i /></span></label><div><span><i><MarketingIcon name="check" size={12} /></i> Exigir e-mail corporativo</span><span><i><MarketingIcon name="check" size={12} /></i> Match sócio × decisor</span><span><i /> Exigir apenas celular</span></div></div>;
